...
const ChatApp = () => {
  ...
  const doctorsType=[{ id: 2, type: "Pneumologist"},
  { id: 3, type: "Cardiologist"},
  { id: 5, type: "Psychologist"}];
  const [messaggigiusti,setmessaggigiusti]=useState([]);

  const chatpassate=[{ id: 3, firstName: "Michael", lastName: "Williams", experienceYears: 8, specialization: "Cardiologist" },
  { id: 8, firstName: "William", lastName: "Wilson", experienceYears: 14, specialization: "Psychologist" }];
  
  const doctors = [
    { id: 1, firstName: "John", lastName: "Smith", experienceYears: 10, specialization: "Psychologist" },
    { id: 2, firstName: "Emma", lastName: "Johnson", experienceYears: 15, specialization: "Psychologist" },
    { id: 3, firstName: "Michael", lastName: "Williams", experienceYears: 8, specialization: "Cardiologist" },
    { id: 4, firstName: "Sophia", lastName: "Brown", experienceYears: 12, specialization: "Cardiologist" },
    { id: 5, firstName: "Olivia", lastName: "Jones", experienceYears: 20, specialization: "Cardiologist" },
    { id: 6, firstName: "James", lastName: "Davis", experienceYears: 18, specialization: "Cardiologist" },
    { id: 7, firstName: "Isabella", lastName: "Miller", experienceYears: 9, specialization: "Psychologist" },
    { id: 8, firstName: "William", lastName: "Wilson", experienceYears: 14, specialization: "Psychologist" },
    { id: 9, firstName: "Ava", lastName: "Moore", experienceYears: 11, specialization: "Pneumologist" },
    { id: 10, firstName: "Ethan", lastName: "Taylor", experienceYears: 16, specialization: "Pneumologist" },
    { id: 11, firstName: "Mia", lastName: "Martinez", experienceYears: 13, specialization: "Pneumologist" },
    { id: 12, firstName: "Alexander", lastName: "Anderson", experienceYears: 17, specialization: "Pneumologist" },
    { id: 13, firstName: "Charlotte", lastName: "Wilson", experienceYears: 10, specialization: "Cardiologist" },
    { id: 14, firstName: "Daniel", lastName: "Thompson", experienceYears: 15, specialization: "Cardiologist" },
    { id: 15, firstName: "Emily", lastName: "White", experienceYears: 8, specialization: "Psychologist" },
    { id: 16, firstName: "Jack", lastName: "Harris", experienceYears: 12, specialization: "Psychologist" },
    { id: 17, firstName: "Abigail", lastName: "Martin", experienceYears: 20, specialization: "Pneumologist" },
    { id: 18, firstName: "William", lastName: "Lee", experienceYears: 18, specialization: "Pneumologist" },
    // Add more doctors as needed
  ];
  
  const messagesHeartIssue = [
    { sender: 'User', text: "Hello, doctor. I've been feeling some discomfort in my chest lately." },
  ...
  const handleNewChat = (doctorId) => {
    ...
    doctorId == 3 ? setmessaggigiusti(messagesHeartIssue) : setmessaggigiusti([]);
            ...
            <ListGroup>
              {chatpassate.map((doctor) => (
                <ListGroup.Item key={doctor.id}>
                  ...
                  <Button variant="success" onClick={() => handleNewChat(doctor.id)} className="float-end">riprendi chat</Button>
                </ListGroup.Item>
              ))}
            </ListGroup>
            </Col>
            ...
            <ListGroup>
              {filteredDoctors.map((doctor) => (
                <ListGroup.Item key={doctor.id}>
                  ...
                  <Button variant="success" onClick={() => handleNewChat(0)} className="float-end">Inizia chat</Button>
                </ListGroup.Item>
              ))}
            </ListGroup>
          </Col>
...
{fakechatpartita &&(
        ...
        <ChatComponent messages={messaggigiusti}/>
